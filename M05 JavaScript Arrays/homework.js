...
function mesesDelAño(array) {
   ...
   if(array[i]=== "Enero" ||array[i]=== "Marzo"||array[i]=== "Noviembre")aux.push(array[i]);
...
function tablaDelSeis() {
   ...
   let tabla=[];
   let num=6;
   for (var i = 0; i<=10; i++)tabla[i]=num*i;
   return tabla;
}
...
function breakStatement(num) {
   ...
   else if(arreglo.length=== 10)return arreglo;
...
function continueStatement(num) {
   ...
   for (var i = 0; i<10; i++)
      ...
      if (i===5)continue; 
        else {valor = valor + 2;arreglo.push(valor);}
